...
WORKDIR /app
RUN apt-get update && apt-get install -y --no-install-recommends fonts-dejavu-core gosu tesseract-ocr tesseract-ocr-eng tesseract-ocr-ron && rm -rf /var/lib/apt/lists/*
